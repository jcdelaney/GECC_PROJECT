...
Files that you will be working with often:
 ...
 - Trials.m - This file contains the function responsible generating the trials object that is displayed by ShowStimuli. This function also writes this information to a log file. Note, runs.m is also used with trials.m in animal go no go. 
